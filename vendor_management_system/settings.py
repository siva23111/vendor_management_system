...
SECRET_KEY = "django-insecure-d-%%u9npe#l)7i19gzoqov)5hsjz)48&c*+nmrc5k-8wj5&xqh"
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Specify the directory where your templates are located
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
